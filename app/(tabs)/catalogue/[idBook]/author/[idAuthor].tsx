  ...
  if (error || !author) {
    return (
      <View className="flex-1 bg-white justify-center items-center p-6">
        ...
        <Text className="mt-4 text-center text-red-600 font-medium">{error || "Autor no encontrado"}</Text>
      </View>
    );
  }
      ...
      <ScrollView className="flex-1">
        ...
        <View className="mx-6 mb-6 p-4 bg-white rounded-xl shadow-sm">
          ...
          <View className="flex-row items-center mb-2">
            <Ionicons name="calendar-outline" size={20} color="#D97706" className="mr-3" />
            <Text className="text-gray-600">
              <Text className="font-medium">Nacimiento: {formattedBirthDate || "Desconocidos"}</Text> 
            </Text>
          </View>

          <View className="flex-row items-center mb-2">
            <Ionicons name="location-outline" size={20} color="#D97706" className="mr-3" />
            <Text className="text-gray-600">
              <Text className="font-medium">Lugar: {author.birthplace || "Desconocido"}</Text> 
            </Text>
          </View>

          <View className="flex-row items-center mb-2">
            <Ionicons name="flag-outline" size={20} color="#D97706" className="mr-3" />
            <Text className="text-gray-600">
              <Text className="font-medium">Nacionalidad: {author.nationality || "Desconocido"}</Text> 
            </Text>
          </View>
        </View>
         {/* Géneros literarios */}
